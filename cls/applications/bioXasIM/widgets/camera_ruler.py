...
class CameraRuler(QtWidgets.QWidget):
    ...
    '''
    def __init__(self, mode=camruler_mode.LOCAL):
        super(CameraRuler, self).__init__()
        uic.loadUi(widgetsUiDir + '/camera_ruler.ui', self)
        ...
        if(mode == camruler_mode.SERVER):
            ...
            self.camera_dev = FleaCamera('Grasshopper2')
