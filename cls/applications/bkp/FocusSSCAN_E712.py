...
#from test_detector import LineDetectorFlyerDevice, LineDetectorDevice

_logger = get_module_logger(__name__)


class FocusSSCAN_E712(BaseScan):
    '''
    ...
    def __init__(self):
        ...
        :returns: None
        """
        super(FocusSSCAN_E712, self).__init__('%sstxm' % MAIN_OBJ.get_sscan_prefix(), 'FOCUSE712WG', main_obj=MAIN_OBJ)
