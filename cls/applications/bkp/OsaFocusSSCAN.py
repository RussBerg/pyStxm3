...
class OsaFocusSSCAN(BaseScan):
    ...
    def __init__(self):
        ...
        :returns: None
        """
        super(OsaFocusSSCAN, self).__init__('%sstxm'% MAIN_OBJ.get_sscan_prefix(), 'XYZ', main_obj=MAIN_OBJ)
    ...
    def configure(self, wdg_com, sp_id=0, line=False, restore=True, z_enabled=True):
        ...
        #self.configure_x_y_z_scan(sp_db, line=line, z_enabled=z_enabled)
