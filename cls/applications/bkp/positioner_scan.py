...
from cls.applications.pyStxm.scan_plugins.PositionerScan import PositionerScanClass
...
class PositionerScanParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.sscan_class = PositionerScanClass()
    ...
    def init_plugin(self):
        ...
        self.axis_strings = ['%s Y microns', '%s X microns', '', '']
    ...
    def populate_positioner_cbox(self):
        skip_lst = [DNM_ZONEPLATE_Z_BASE, DNM_COARSE_X, DNM_COARSE_Y, DNM_OSA_Z_BASE]

        if (self.sample_positioning_mode == sample_positioning_modes.GONIOMETER):
            skip_lst = merge_to_one_list([skip_lst, [DNM_SAMPLE_X, DNM_SAMPLE_Y, DNM_SAMPLE_FINE_X, DNM_SAMPLE_FINE_Y]])
