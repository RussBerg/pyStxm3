...
class dev_config_sim_ambient(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = Motor_Qt('%sIOC:m1' % DEVPRFX,pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = Motor_Qt('%sIOC:m2' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_COARSE_X] = Motor_Qt( '%sIOC:m3' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_COARSE_Y] = Motor_Qt( '%sIOC:m4' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_OSA_X] = Motor_Qt('%sIOC:m5' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_OSA_Y] = Motor_Qt('%sIOC:m6' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_DETECTOR_X] = Motor_Qt( '%sIOC:m7' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_DETECTOR_Y] = Motor_Qt( '%sIOC:m8' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( '%sIOC:m1' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( '%sIOC:m10' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_SAMPLE_X] = Motor_Qt( '%sIOC:m11' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = Motor_Qt('%sIOC:m12' % DEVPRFX, pos_set=POS_TYPE_ES)

        self.devices['POSITIONERS'][DNM_COARSE_Z] = Motor_Qt('%sIOC:m13' % DEVPRFX, pos_set=POS_TYPE_ES)
...
class dev_config_amb(dev_config_base):
    ...
    def init_presets(self):
        ...
        self.devices['PRESETS']['USE_E712_HDW_ACCEL'] = False
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = sample_motor('%sIOC:m1' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = sample_motor('%sIOC:m2' % DEVPRFX, pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( '%sIOC:m1' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( '%sIOC:m10' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z_BASE] = Motor_Qt( '%sIOC:m10')

        #self.devices['POSITIONERS'][DNM_SAMPLE_X] = Motor_Qt( '%sIOC:m11' % DEVPRFX, pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_SAMPLE_Y] = Motor_Qt('%sIOC:m12' % DEVPRFX, pos_set=POS_TYPE_ES)

        self.devices['POSITIONERS'][DNM_SAMPLE_X] = sample_abstract_motor( '%sIOC:m11' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = sample_abstract_motor('%sIOC:m12' % DEVPRFX, pos_set=POS_TYPE_ES)
...
class dev_config_uhv(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = e712_sample_motor('%sIOC:m100' % DEVPRFX, name='%sIOC:m100' % DEVPRFX, pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_X] = Motor_Qt('%sIOC:m100', name='%sIOC:m100')
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_FINE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = e712_sample_motor('%sIOC:m101' % DEVPRFX, name='%sIOC:m101' % DEVPRFX, pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_Y] = Motor_Qt('%sIOC:m101', name='%sIOC:m101')
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_X)
        self.devices['POSITIONERS'][DNM_COARSE_X] = Motor_Qt( '%sIOC:m112' % DEVPRFX, name='%sIOC:m112' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_Y)
        self.devices['POSITIONERS'][DNM_COARSE_Y] = Motor_Qt( '%sIOC:m113' % DEVPRFX, name='%sIOC:m113' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_X)
        self.devices['POSITIONERS'][DNM_OSA_X] = Motor_Qt('%sIOC:m104' % DEVPRFX, name='%sIOC:m104' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Y)
        self.devices['POSITIONERS'][DNM_OSA_Y] = Motor_Qt('%sIOC:m105' % DEVPRFX, name='%sIOC:m105' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Z)
        self.devices['POSITIONERS'][DNM_OSA_Z] = Motor_Qt('%sIOC:m106C' % DEVPRFX, name='%sIOC:m106C' % DEVPRFX, pos_set=POS_TYPE_ES, collision_support=True)
        ...
        self.devices['POSITIONERS'][DNM_DETECTOR_X] = Motor_Qt( '%sIOC:m114' % DEVPRFX, name='%sIOC:m114' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Y)
        self.devices['POSITIONERS'][DNM_DETECTOR_Y] = Motor_Qt( '%sIOC:m115' % DEVPRFX, name='%sIOC:m115' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Z)
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( '%sIOC:m116' % DEVPRFX, name='%sIOC:m116' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_X)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_X] = e712_sample_motor( '%sIOC:m102' % DEVPRFX, name='%sIOC:m102' % DEVPRFX, pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_ZX] = Motor_Qt( '%sIOC:m102', name='%sIOC:m102')
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Y)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Y] = e712_sample_motor( '%sIOC:m103' % DEVPRFX, name='%sIOC:m103' % DEVPRFX, pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_ZY] = Motor_Qt('%sIOC:m102', name='%sIOC:m102')
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Z)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( '%sIOC:m111C' % DEVPRFX, name='%sIOC:m111C' % DEVPRFX, pos_set=POS_TYPE_ES, collision_support=True)
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Z_BASE)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z_BASE] = Motor_Qt( '%sIOC:m111' % DEVPRFX, name='%sIOC:m111' % DEVPRFX )
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_X] = sample_abstract_motor( '%sIOC:m117' % DEVPRFX, name='%sIOC:m117' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = sample_abstract_motor('%sIOC:m118' % DEVPRFX, name='%sIOC:m118' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_X)
        self.devices['POSITIONERS'][DNM_GONI_X] = Motor_Qt('%sIOC:m107' % DEVPRFX, name='%sIOC:m107' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_Y)
        self.devices['POSITIONERS'][DNM_GONI_Y] = Motor_Qt('%sIOC:m108' % DEVPRFX, name='%sIOC:m108' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_Z)
        self.devices['POSITIONERS'][DNM_GONI_Z] = Motor_Qt('%sIOC:m109' % DEVPRFX, name='%sIOC:m109' % DEVPRFX, pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_THETA)
        self.devices['POSITIONERS'][DNM_GONI_THETA] = Motor_Qt('%sIOC:m110' % DEVPRFX, name='%sIOC:m110' % DEVPRFX, pos_set=POS_TYPE_ES)
...
def connect_standard_beamline_positioners(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['POSITIONERS'][DNM_ENERGY] = Motor_Qt('%sBL1610-I10:ENERGY' % DEVPRFX, name='%sBL1610-I10:ENERGY' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_ES)
    devcfg.msg_splash("connecting to: [%s]" % DNM_SLIT_X)
    dev_dct['POSITIONERS'][DNM_SLIT_X] = Motor_Qt('%sBL1610-I10:slitX' % DEVPRFX, name='%sBL1610-I10:slitX' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_SLIT_Y)
    dev_dct['POSITIONERS'][DNM_SLIT_Y] = Motor_Qt('%sBL1610-I10:slitY' % DEVPRFX, name='%sBL1610-I10:slitY' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_M3_PITCH)
    dev_dct['POSITIONERS'][DNM_M3_PITCH] = Motor_Qt('%sBL1610-I10:m3STXMPitch' % DEVPRFX, name='%sBL1610-I10:m3STXMPitch' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_GAP)
    dev_dct['POSITIONERS'][DNM_EPU_GAP] = Motor_Qt('%sBL1610-I10:epuGap' % DEVPRFX, name='%sBL1610-I10:epuGap' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_OFFSET)
    dev_dct['POSITIONERS'][DNM_EPU_OFFSET] = Motor_Qt('%sBL1610-I10:epuOffset' % DEVPRFX, name='%sBL1610-I10:epuOffset' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_HARMONIC)
    dev_dct['POSITIONERS'][DNM_EPU_HARMONIC] = Motor_Qt('%sBL1610-I10:epuHarmonic' % DEVPRFX, name='%sBL1610-I10:epuHarmonic' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_POLARIZATION)
    dev_dct['POSITIONERS'][DNM_EPU_POLARIZATION] = Motor_Qt('%sBL1610-I10:epuPolarization' % DEVPRFX, name='%sBL1610-I10:epuPolarization' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_ANGLE)
    dev_dct['POSITIONERS'][DNM_EPU_ANGLE] = Motor_Qt('%sBL1610-I10:epuAngle' % DEVPRFX, name='%sBL1610-I10:epuAngle' % DEVPRFX, abstract_mtr=True, pos_set=POS_TYPE_BL)
...
def connect_devices(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['DETECTORS'][DNM_PMT] = make_basedevice('DETECTORS', '%s%sPMT:ctr:SingleValue_RBV' %  (DEVPRFX, prfx), devcfg=devcfg)
    ...
    dev_dct['DETECTORS'][DNM_POINT_DET] = PointDetectorDevice('%s%sCI:counter:' % (DEVPRFX, prfx), name=DNM_DEFAULT_COUNTER)
    dev_dct['DIO'][DNM_POINT_GATE] = GateDevice('%suhvCO:gate:' % (DEVPRFX), name='gate_control')

    dev_dct['DETECTORS'][DNM_LINE_DET] = LineDetectorDevice('%s%sCI:counter:' % (DEVPRFX, prfx), name=DNM_DEFAULT_COUNTER)
    dev_dct['DETECTORS'][DNM_LINE_DET_FLYER] = LineDetectorFlyerDevice('%s%sCI:counter:' % (DEVPRFX, prfx), name=DNM_DEFAULT_COUNTER,
                                                  stream_names={'line_det_strm': 'primary'},
                                                  monitor_attrs=['waveform_rbv'], pivot=False)


    dev_dct['PVS'][DNM_RING_CURRENT] = make_basedevice('PVS', '%sPCT1402-01:mA:fbk' % (DEVPRFX), units='mA', devcfg=devcfg)
...
#    dev_dct['DETECTORS_NO_RECORD']['OsaCntr_Snapshot'] = BaseDevice('%sPMT:osa_snapshot_RBV' % prfx)
    ...
    dev_dct['PVS'][DNM_CALCD_ZPZ] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:zp:fbk:tr_I' % (DEVPRFX, prfx),
                                                  devcfg=devcfg)
    dev_dct['PVS']['Zpz_adjust'] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:zp:adjust_zpz' % (DEVPRFX, prfx), devcfg=devcfg)
    ...
    dev_dct['PVS'][DNM_ZONEPLATE_SCAN_MODE] = Mbbo('%sBL1610-I10:ENERGY:%s:zp:scanselflag' % (DEVPRFX, prfx))  # used to control which value gets sent to Zpz, fl or fl - A0
    ...
    dev_dct['PVS'][DNM_ZONEPLATE_INOUT_FBK] = Mbbi('%sBL1610-I10:%s:zp_inout:fbk' % (DEVPRFX, prfx))  # used to convieniently move zp z in and out
    #used to adjust the current focus value, the delta represents the relative microns for zpz to move to new focus position
    dev_dct['PVS'][DNM_DELTA_A0] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:delta_A0' % (DEVPRFX, prfx), devcfg=devcfg)
    dev_dct['PVS'][DNM_FOCAL_LEN] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:zp:FL' % (DEVPRFX, prfx), units='um', devcfg=devcfg)
    ...
    dev_dct['PVS'][DNM_A0_FOR_CALC] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:A0:for_calc' % (DEVPRFX, prfx), devcfg=devcfg)

    devcfg.msg_splash("connecting to: [%s]" % 'zoneplate definitions')
    dev_dct['PVS'][DNM_ZPZ_POS] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:zp:zpz_pos' % (DEVPRFX, prfx), devcfg=devcfg)
    ...
    dev_dct['PVS'][DNM_ENERGY_RBV] = make_basedevice('PVS', '%sBL1610-I10:ENERGY.RBV' % (DEVPRFX), units='um', devcfg=devcfg)
    ...
    dev_dct['PVS'][DNM_MONO_EV_FBK] = make_basedevice('PVS', '%sMONO1610-I10-01:energy:fbk'% (DEVPRFX), units='eV', devcfg=devcfg)
    ...
    dev_dct['PVS']['Epu_pol_angle'] = make_basedevice('PVS', '%sUND1410-01:polarAngle' % (DEVPRFX), units='udeg', devcfg=devcfg)

    devcfg.msg_splash("connecting to: [%s]" % 'Epu_gap_fbk')
    dev_dct['PVS']['Epu_gap_fbk'] = make_basedevice('PVS', '%sUND1410-01:gap:mm:fbk' % (DEVPRFX), units='mm', devcfg=devcfg)

    # devcfg.msg_splash("connecting to: [%s]" % 'Epu_gap_fbk')
    # dev_dct['PVS']['Epu_gap_fbk'] = BaseDevice('RUSSTEST:VAL')

    dev_dct['PVS']['Epu_gap_offset'] = make_basedevice('PVS', '%sUND1410-01:gap:offset' % (DEVPRFX), units='mm', devcfg=devcfg)
    ...
    dev_dct['PVS'][DNM_BEAM_DEFOCUS] = make_basedevice('PVS','%sBL1610-I10:ENERGY:%s:zp:defocus' % (DEVPRFX, prfx), units='um', devcfg=devcfg)

    dev_dct['PVS_DONT_RECORD']['ticker'] = make_basedevice('PVS_DONT_RECORD','%sTRG2400:cycles' % (DEVPRFX), units='counts', devcfg=devcfg)
    ...
    dev_dct['PVS_DONT_RECORD']['accRange'] = make_basedevice('PVS_DONT_RECORD', '%s%sTestSIG:signal:MaxPoints'% (DEVPRFX, prfx), devcfg=devcfg)
...
#    dev_dct['PVS_DONT_RECORD']['OSAZ_goto_lockposition'] = BaseDevice('%sBL1610-I10:ENERGY:%s:osaz_goto_lockpos' % prfx)
    ...
    dev_dct['PVS_DONT_RECORD'][DNM_SET_XY_LOCKPOSITION] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:set_xy:lockposn' % (DEVPRFX, prfx), units='um', devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD'][DNM_SET_Z_LOCKPOSITION] = make_basedevice('PVS', '%sBL1610-I10:ENERGY:%s:set_z:lock_posn' % (DEVPRFX, prfx), units='um', devcfg=devcfg)

    dev_dct['PVS'][DNM_AX1_INTERFER_VOLTS] = make_basedevice('PVS', '%s%sAi:ai:ai0_RBV' % (DEVPRFX, prfx), rd_only=True, devcfg=devcfg)
    dev_dct['PVS'][DNM_AX2_INTERFER_VOLTS] = make_basedevice('PVS', '%s%sAi:ai:ai1_RBV' % (DEVPRFX, prfx), rd_only=True, devcfg=devcfg)
...
def connect_temperatures(dev_dct, prfx='uhv', devcfg=None):
    ...
    # ES = endstation temperatures
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-01]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-01'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-01'% (DEVPRFX), desc='Turbo cooling water', units='deg C', devcfg=devcfg)
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-30]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-30'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-30'% (DEVPRFX), desc='Sample Coarse Y', units='deg C', devcfg=devcfg)
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-32]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-32'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-32'% (DEVPRFX), desc='Detector Y', units='deg C', devcfg=devcfg)
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-21]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-21'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-21'% (DEVPRFX), desc='Chamber temp #1', units='deg C', devcfg=devcfg)
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-22]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-22'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-22'% (DEVPRFX), desc='Chamber temp #2', units='deg C', devcfg=devcfg)
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-23]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-23'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-23'% (DEVPRFX), desc='Chamber temp #3', units='deg C', devcfg=devcfg)
    #devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-24]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-24'] = make_basedevice('TEMPERATURES','%sTM1610-3-I12-24'% (DEVPRFX), desc='Chamber temp #4', units='deg C', devcfg=devcfg)
...
def connect_heartbeats(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['blApi_hrtbt'] = { 'dev': Bo('%s%sBlApi:hrtbt:alive' % (DEVPRFX, prfx)), 'desc': 'BlApi App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['ai_hrtbt'] = {'dev': Bo('%s%sAI:hrtbt:alive' % (DEVPRFX, prfx)), 'desc': 'AnalogInput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['ci_hrtbt'] = {'dev': Bo('%s%sCI:hrtbt:alive' % (DEVPRFX, prfx)), 'desc': 'CounterInput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['co_hrtbt'] = {'dev': Bo('%s%sCO:hrtbt:alive' % (DEVPRFX, prfx)), 'desc': 'CounterOutput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['dio_hrtbt'] = {'dev': Bo('%s%sDIO:hrtbt:alive' % (DEVPRFX, prfx)), 'desc': 'Digital IO App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_hrtbt'] = {'dev': Bo('%s%sMTRS:hrtbt:alive' % (DEVPRFX, prfx.upper())), 'desc': 'Main Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtr_calib_hrtbt'] = {'dev': Bo('%s%sMTR_CALIB:hrtbt:alive' % (DEVPRFX, prfx.upper())), 'desc': 'MotorCalibrations'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_osa_hrtbt'] = {'dev': Bo('%s%sMTR_OSA:hrtbt:alive' % (DEVPRFX, prfx.upper())), 'desc': 'OSA Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_zp_hrtbt'] = {'dev': Bo('%s%sMTR_ZP:hrtbt:alive' % (DEVPRFX, prfx.upper())), 'desc': 'ZPz Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['gate_cntr_scan_cfg'] = {'dev': Bo('%sgate_cntr_scan_cfg:hrtbt:alive' % (DEVPRFX)), 'desc': 'Gate/Counter scan cfg App'}
...
def connect_e712(dev_dct, prfx='uhv', e712_prfx='IOCE712', devcfg=None):
    ...
    dev_dct['WIDGETS'][DNM_E712_OPHYD_DEV] = E712WGDevice('%s%s:' % (DEVPRFX, e712_prfx), name='e712_wgenerator_flyerdev')
    # waveform PV
    dev_dct['PVS_DONT_RECORD']['e712_dwells'] = make_basedevice('PVS_DONT_RECORD', '%s%s:dwells' % (DEVPRFX, e712_prfx), units='mA', devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_xresetposns'] = make_basedevice('PVS_DONT_RECORD', '%s%s:xreset:posns' % (DEVPRFX, e712_prfx), units='um', devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_yresetposns'] = make_basedevice('PVS_DONT_RECORD', '%s%s:yreset:posns' % (DEVPRFX, e712_prfx), units='um', devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_sp_ids'] = make_basedevice('PVS_DONT_RECORD', '%s%s:sp_roi:ids' % (DEVPRFX, e712_prfx), devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_current_sp_id'] = make_basedevice('PVS_DONT_RECORD', '%s%s:sp_roi:current' % (DEVPRFX, e712_prfx), devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_x_start_pos'] = make_basedevice('PVS_DONT_RECORD', '%s%s:XStartPos' % (DEVPRFX, e712_prfx), devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_y_start_pos'] = make_basedevice('PVS_DONT_RECORD', '%s%s:YStartPos' % (DEVPRFX, e712_prfx), devcfg=devcfg)

    # pvs that will hold up to 10 DDL tables for a multi spatial scan
    dev_dct['PVS_DONT_RECORD']['e712_ddl_tbls'] = [ make_basedevice('PVS_DONT_RECORD', '%s%s:ddl:0' % (DEVPRFX, e712_prfx), devcfg=devcfg),
    ...
    dev_dct['PVS_DONT_RECORD']['e712_image_idx'] = make_basedevice('PVS_DONT_RECORD', '%s%s:image_idx' % (DEVPRFX, e712_prfx), devcfg=devcfg)
    dev_dct['PVS_DONT_RECORD']['e712_scan_mode'] = make_basedevice('PVS_DONT_RECORD', '%s%s:ScanMode' % (DEVPRFX, e712_prfx), devcfg=devcfg)
    ...
    if (MAIN_OBJ.get_fine_sample_positioning_mode() is sample_fine_positioning_modes.ZONEPLATE):
        ...
        dev_dct['PVS_DONT_RECORD']['e712_x_start_mode'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg3:startmode' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_start_mode'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg4:startmode' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_wavtbl_ids'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg3_tbl:ids' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_wavtbl_ids'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg4_tbl:ids' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        # short PV's
        dev_dct['PVS_DONT_RECORD']['e712_x_npts'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg3:npts' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_npts'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg4:npts' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        # pvs that hold the flags for each waveformgenerator (4) for each supported sp_roi (max of 10)
        dev_dct['PVS_DONT_RECORD']['e712_x_useddl'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg3:useddl' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_useddl'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg4:useddl' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_usereinit'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg3:usereinit' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_usereinit'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg4:usereinit' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_strtatend'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg3:strtatend' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_strtatend'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg4:strtatend' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_usetablenum'] = make_basedevice('PVS_DONT_RECORD', '%s%s:WavGen3UseTblNum' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_usetablenum'] = make_basedevice('PVS_DONT_RECORD', '%s%s:WavGen4UseTblNum' % (DEVPRFX, e712_prfx), devcfg=devcfg)

    else:
        # here using x1 and y1 because we are sample scanning and they are channels 1 and 2 respectively
        # waveform PV's
        dev_dct['PVS_DONT_RECORD']['e712_x_start_mode'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg1:startmode' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_start_mode'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg2:startmode' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_wavtbl_ids'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg1_tbl:ids' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_wavtbl_ids'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg2_tbl:ids' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        # short PV's
        dev_dct['PVS_DONT_RECORD']['e712_x_npts'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg1:npts' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_npts'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg2:npts' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        # pvs that hold the flags for each waveformgenerator (4) for each supported sp_roi (max of 10)
        dev_dct['PVS_DONT_RECORD']['e712_x_useddl'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg1:useddl' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_useddl'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg2:useddl' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_usereinit'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg1:usereinit' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_usereinit'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg2:usereinit' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_strtatend'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg1:strtatend' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_strtatend'] = make_basedevice('PVS_DONT_RECORD', '%s%s:wg2:strtatend' % (DEVPRFX, e712_prfx), devcfg=devcfg)

        dev_dct['PVS_DONT_RECORD']['e712_x_usetablenum'] = make_basedevice('PVS_DONT_RECORD', '%s%s:WavGen1UseTblNum' % (DEVPRFX, e712_prfx), devcfg=devcfg)
        dev_dct['PVS_DONT_RECORD']['e712_y_usetablenum'] = make_basedevice('PVS_DONT_RECORD', '%s%s:WavGen2UseTblNum' % (DEVPRFX, e712_prfx), devcfg=devcfg)
...
def connect_BL_devices(dev_dct, prfx='uhv', devcfg=None):
    if(prfx.find('uhv') > -1):
        ...
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1410-01:vac:p'] = make_basedevice('PRESSURES', '%sCCG1410-01:vac:p'% (DEVPRFX), desc='Sec. 1', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1410-I00-01:vac:p'] = make_basedevice('PRESSURES', '%sCCG1410-I00-01:vac:p'% (DEVPRFX), desc='Sec. 2', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1410-I00-02:vac:p'] = make_basedevice('PRESSURES', '%sCCG1410-I00-02:vac:p'% (DEVPRFX), desc='Sec. 4', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-1-I00-02:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-1-I00-02:vac:p'% (DEVPRFX), desc='Sec. 6', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['HCG1610-1-I00-01:vac:p'] = make_basedevice('PRESSURES', '%sHCG1610-1-I00-01:vac:p'% (DEVPRFX), desc='Sec. 7', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-1-I00-03:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-1-I00-03:vac:p'% (DEVPRFX), desc='Sec. 8', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-01:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-I10-01:vac:p'% (DEVPRFX), desc='Sec. 10', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-03:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-I10-03:vac:p'% (DEVPRFX), desc='Sec. 12', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-04:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-I10-04:vac:p'% (DEVPRFX), desc='Sec. 13', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I12-01:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-I12-01:vac:p'% (DEVPRFX),desc='Sec. 14', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I12-02:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-I12-02:vac:p'% (DEVPRFX), desc='Sec. 15', units='torr', devcfg=devcfg)
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-3-I12-01:vac:p'] = make_basedevice('PRESSURES', '%sCCG1610-3-I12-01:vac:p'% (DEVPRFX), desc='Sec. 16', units='torr', devcfg=devcfg)
...
#from cls.applications.pyStxm.bl_configs.uhv_bl10ID1 import DEVICE_CFG
