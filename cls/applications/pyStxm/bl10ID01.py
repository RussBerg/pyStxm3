...
class dev_config_sim_ambient(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( 'IOC:m10',pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_COARSE_Z] = Motor_Qt('IOC:m13',pos_set=POS_TYPE_ES)
...
class dev_config_amb(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( 'IOC:m9',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( 'IOC:m10',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z_BASE] = Motor_Qt( 'IOC:m10')
...
class dev_config_uhv(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = e712_sample_motor('IOC:m100', name='IOC:m100', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_X] = Motor_Qt('IOC:m100', name='IOC:m100')
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_FINE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = e712_sample_motor('IOC:m101', name='IOC:m101', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_Y] = Motor_Qt('IOC:m101', name='IOC:m101')
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_X)
        self.devices['POSITIONERS'][DNM_COARSE_X] = Motor_Qt( 'IOC:m112', name='IOC:m112', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_Y)
        self.devices['POSITIONERS'][DNM_COARSE_Y] = Motor_Qt( 'IOC:m113', name='IOC:m113', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_X)
        self.devices['POSITIONERS'][DNM_OSA_X] = Motor_Qt('IOC:m104', name='IOC:m104', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Y)
        self.devices['POSITIONERS'][DNM_OSA_Y] = Motor_Qt('IOC:m105', name='IOC:m105', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Z)
        self.devices['POSITIONERS'][DNM_OSA_Z] = Motor_Qt('IOC:m106C', name='IOC:m106C', pos_set=POS_TYPE_ES, collision_support=True)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Z_BASE)
        self.devices['POSITIONERS'][DNM_OSA_Z_BASE] = Motor_Qt('IOC:m106', name='IOC:m106', )

        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_X)
        self.devices['POSITIONERS'][DNM_DETECTOR_X] = Motor_Qt( 'IOC:m114', name='IOC:m114', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Y)
        self.devices['POSITIONERS'][DNM_DETECTOR_Y] = Motor_Qt( 'IOC:m115', name='IOC:m115', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Z)
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( 'IOC:m116', name='IOC:m116', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_X)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_X] = e712_sample_motor( 'IOC:m102', name='IOC:m102', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_ZX] = Motor_Qt( 'IOC:m102', name='IOC:m102')
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Y)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Y] = e712_sample_motor( 'IOC:m103', name='IOC:m103', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_ZY] = Motor_Qt('IOC:m102', name='IOC:m102')
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Z)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( 'IOC:m111C', name='IOC:m111C', pos_set=POS_TYPE_ES, collision_support=True)
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Z_BASE)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z_BASE] = Motor_Qt( 'IOC:m111', name='IOC:m111' )
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_X] = sample_abstract_motor( 'IOC:m117', name='IOC:m117', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = sample_abstract_motor('IOC:m118', name='IOC:m118', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_X)
        self.devices['POSITIONERS'][DNM_GONI_X] = Motor_Qt('IOC:m107', name='IOC:m107', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_Y)
        self.devices['POSITIONERS'][DNM_GONI_Y] = Motor_Qt('IOC:m108', name='IOC:m108', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_Z)
        self.devices['POSITIONERS'][DNM_GONI_Z] = Motor_Qt('IOC:m109', name='IOC:m109', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_THETA)
        self.devices['POSITIONERS'][DNM_GONI_THETA] = Motor_Qt('IOC:m110', name='IOC:m110', pos_set=POS_TYPE_ES)
...
#    dev_dct['DETECTORS_NO_RECORD']['OsaCntr_Snapshot'] = BaseDevice('%sPMT:osa_snapshot_RBV' % prfx)
    ...
    dev_dct['PVS_DONT_RECORD']['CX_auto_disable_power'] = BaseDevice('IOC:m112:XPS_AUTO_DISABLE_MODE')
    dev_dct['PVS_DONT_RECORD']['CY_auto_disable_power'] = BaseDevice('IOC:m113:XPS_AUTO_DISABLE_MODE')
    dev_dct['PVS_DONT_RECORD']['DX_auto_disable_power'] = BaseDevice('IOC:m114:XPS_AUTO_DISABLE_MODE')
    dev_dct['PVS_DONT_RECORD']['DY_auto_disable_power'] = BaseDevice('IOC:m115:XPS_AUTO_DISABLE_MODE')
