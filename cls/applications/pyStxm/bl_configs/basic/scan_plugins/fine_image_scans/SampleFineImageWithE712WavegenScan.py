...
class SampleFineImageWithE712WavegenScanClass(BaseScan):
    ...
    def __init__(self, main_obj=None):
        ...
        :returns: None
        """
        super(SampleFineImageWithE712WavegenScanClass, self).__init__(main_obj=MAIN_OBJ)
    ...
    def configure(self, wdg_com, sp_id=0, ev_idx=0, line=True, block_disconnect_emit=False):
        ...
        """
        super(SampleFineImageWithE712WavegenScanClass, self).configure(wdg_com, sp_id=sp_id, line=line, z_enabled=False)
        _logger.info('\n\nSampleFineImageWithE712WavegenScanClass: configuring sp_id [%d]' % sp_id)
