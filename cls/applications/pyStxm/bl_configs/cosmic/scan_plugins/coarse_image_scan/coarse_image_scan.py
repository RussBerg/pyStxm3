...
from cls.types.stxmTypes import scan_types, scan_sub_types, \
    energy_scan_order_types, sample_positioning_modes, sample_fine_positioning_modes,scan_types, spatial_type_prefix, image_types
...
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.coarse_image_scan.CoarseSampleImageScan import CoarseSampleImageScanClass
...
class CoarseImageScanParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._parent = parent
        uic.loadUi(os.path.join(os.path.dirname(__file__), 'coarse_image_scan.ui'), self)
