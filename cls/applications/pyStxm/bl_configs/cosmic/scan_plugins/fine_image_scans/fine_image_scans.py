...
from cls.types.stxmTypes import scan_types, scan_sub_types, image_scan_secids, spatial_type_prefix, sample_positioning_modes, sample_fine_positioning_modes, scan_image_types
...
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.fine_image_scans.SampleFineImageWithE712WavegenScan import SampleFineImageWithE712WavegenScanClass
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.fine_image_scans.SampleFineImageScan import FineSampleImageScanClass
...
class FineImageScansParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._parent = parent
        uic.loadUi( os.path.join(os.path.dirname(__file__), 'fine_image_scans.ui'), self)
    ...
    def init_plugin(self):
        ...
        self._type_skip_centering_scans = True  # [scan_panel_order.FOCUS_SCAN, scan_panel_order.TOMOGRAPHY,
