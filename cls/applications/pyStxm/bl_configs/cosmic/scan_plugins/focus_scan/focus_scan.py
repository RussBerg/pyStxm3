...
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.focus_scan.FocusScan import FocusScanClass
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.focus_scan.FocusE712Scan import FocusE712ScanClass
...
class FocusScanParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._parent = parent
        uic.loadUi(  os.path.join( os.path.dirname(__file__), 'focus_scan.ui'), self)
    ...
    def init_plugin(self):
        ...
        self._type_skip_scan_q_table_plots = True  # [scan_panel_order.OSA_FOCUS_SCAN, scan_panel_order.FOCUS_SCAN]
