...
from cls.types.stxmTypes import scan_types, scan_sub_types, spatial_type_prefix, sample_positioning_modes, scan_image_types
...
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.line_scan.LineSpecScan import LineSpecScanClass
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.line_scan.LineSpecSSCANWithE712WavegenScan import LineSpecScanWithE712WavegenClass
...
class LineScansParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        uic.loadUi( os.path.join(os.path.dirname(__file__), 'line_scan.ui'), self)
