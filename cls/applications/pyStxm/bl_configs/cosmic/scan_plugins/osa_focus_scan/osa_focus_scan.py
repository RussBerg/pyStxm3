...
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.osa_focus_scan.OsaFocusScan import OsaFocusScanClass
...
class OsaFocusScanParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._parent = parent
        uic.loadUi(os.path.join(os.path.dirname(__file__), 'osa_focus_scan.ui'), self)
