...
#from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.osa_scan.osa_scan_tester import test_sp_db

from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.osa_scan.OsaScan import OsaScanClass
...
class OsaScanParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._parent = parent
        uic.loadUi( os.path.join(os.path.dirname(__file__), 'osa_scan.ui'), self)
