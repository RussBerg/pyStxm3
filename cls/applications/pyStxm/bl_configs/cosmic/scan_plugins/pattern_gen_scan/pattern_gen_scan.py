...
from cls.types.stxmTypes import scan_types, scan_sub_types, spatial_type_prefix, \
...
from cls.applications.pyStxm.bl_configs.cosmic.scan_plugins.pattern_gen_scan.PatternGenScan import PatternGenScanClass
