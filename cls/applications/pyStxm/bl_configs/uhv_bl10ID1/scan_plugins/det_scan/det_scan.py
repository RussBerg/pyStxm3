...
from cls.applications.pyStxm.bl_configs.uhv_bl10ID1.scan_plugins.det_scan.DetectorScan import DetectorScanClass
...
class DetectorScanParam(ScanParamWidget):
	...
	def __init__(self, parent=None):
		...
		self._parent = parent
		uic.loadUi(os.path.join(os.path.dirname(__file__), 'det_scan.ui'), self)
