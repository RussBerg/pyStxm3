...
from cls.applications.pyStxm.bl_configs.uhv_bl10ID1.scan_plugins.tomography_scan.TomographyWithE712WavegenScan import TomographyWithE712WavegenScanClass
...
class TomographyScanParam(ScanParamWidget):
    ...
    def __init__(self, parent=None):
        ...
        uic.loadUi(os.path.join(os.path.dirname(__file__), 'tomography_scan.ui'), self)
        ...
        if (self.sample_positioning_mode != sample_positioning_modes.GONIOMETER):
            ...
            self.tomo_zpz_adjust_wdg = uic.loadUi(os.path.join(os.path.dirname(__file__), 'tomo_zpz_adjust.ui'))
