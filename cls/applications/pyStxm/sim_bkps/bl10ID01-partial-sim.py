...
class dev_config_uhv(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = e712_sample_motor('SIM_IOC:m100', name='SIM_IOC:m100',
                                                                           pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = e712_sample_motor('SIM_IOC:m101', name='SIM_IOC:m101',
                                                                           pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_OSA_Z] = Motor_Qt('SIM_IOC:m106C', name='SIM_IOC:m106C', pos_set=POS_TYPE_ES,
        ...
        self.devices['POSITIONERS'][DNM_ZONEPLATE_X] = e712_sample_motor('SIM_IOC:m102', name='SIM_IOC:m102',
                                                                         pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Y] = e712_sample_motor('SIM_IOC:m103', name='SIM_IOC:m103',
                                                                         pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt('SIM_IOC:m111C', name='SIM_IOC:m111C',
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_X] = sample_abstract_motor('SIM_IOC:m117', name='SIM_IOC:m117',
                                                                          pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = sample_abstract_motor('SIM_IOC:m118', name='SIM_IOC:m118',
                                                                          pos_set=POS_TYPE_ES)
...
def connect_standard_beamline_positioners(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['POSITIONERS'][DNM_ENERGY] = Motor_Qt('SIM_BL1610-I10:ENERGY', name='SIM_BL1610-I10:ENERGY',
                                                  abstract_mtr=True, pos_set=POS_TYPE_ES)
    devcfg.msg_splash("connecting to: [%s]" % DNM_SLIT_X)
    dev_dct['POSITIONERS'][DNM_SLIT_X] = Motor_Qt('SIM_BL1610-I10:slitX', name='SIM_BL1610-I10:slitX',
                                                  abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_SLIT_Y)
    dev_dct['POSITIONERS'][DNM_SLIT_Y] = Motor_Qt('SIM_BL1610-I10:slitY', name='SIM_BL1610-I10:slitY',
                                                  abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_M3_PITCH)
    dev_dct['POSITIONERS'][DNM_M3_PITCH] = Motor_Qt('SIM_BL1610-I10:m3STXMPitch', name='SIM_BL1610-I10:m3STXMPitch',
                                                    abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_GAP)
    dev_dct['POSITIONERS'][DNM_EPU_GAP] = Motor_Qt('SIM_BL1610-I10:epuGap', name='SIM_BL1610-I10:epuGap',
                                                   abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_OFFSET)
    dev_dct['POSITIONERS'][DNM_EPU_OFFSET] = Motor_Qt('SIM_BL1610-I10:epuOffset', name='SIM_BL1610-I10:epuOffset',
                                                      abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_HARMONIC)
    dev_dct['POSITIONERS'][DNM_EPU_HARMONIC] = Motor_Qt('SIM_BL1610-I10:epuHarmonic', name='SIM_BL1610-I10:epuHarmonic',
                                                        abstract_mtr=True, pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_POLARIZATION)
    dev_dct['POSITIONERS'][DNM_EPU_POLARIZATION] = Motor_Qt('SIM_BL1610-I10:epuPolarization',
                                                            name='SIM_BL1610-I10:epuPolarization', abstract_mtr=True,
                                                            pos_set=POS_TYPE_BL)
    devcfg.msg_splash("connecting to: [%s]" % DNM_EPU_ANGLE)
    dev_dct['POSITIONERS'][DNM_EPU_ANGLE] = Motor_Qt('SIM_BL1610-I10:epuAngle', name='SIM_BL1610-I10:epuAngle',
                                                     abstract_mtr=True, pos_set=POS_TYPE_BL)
...
def connect_devices(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['PVS']['Ideal_A0'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:fbk:tr.K' % prfx)
    # dev_dct['PVS']['Calcd_Zpz'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:fbk:tr.L' % prfx)
    dev_dct['PVS']['Calcd_Zpz'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:fbk:tr.I' % prfx)
    ...
    dev_dct['PVS'][DNM_ZONEPLATE_SCAN_MODE] = BaseDevice(
        'SIM_BL1610-I10:ENERGY:%s:zp:scanselflag' % prfx)  # used to control which value gets sent to Zpz, fl or fl - A0
    dev_dct['PVS'][DNM_ZONEPLATE_INOUT] = BaseDevice(
        'SIM_BL1610-I10:%s:zp_inout' % prfx)  # used to convieniently move zp z in and out
    dev_dct['PVS'][DNM_ZONEPLATE_INOUT_FBK] = Mbbi(
        'SIM_BL1610-I10:%s:zp_inout:fbk' % prfx)  # used to convieniently move zp z in and out
    # used to adjust the current focus value, the delta represents the relative microns for zpz to move to new focus position
    dev_dct['PVS']['Delta_A0'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:delta_A0' % prfx)
    dev_dct['PVS']['Focal_Length'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:FL' % prfx, units='um')
    dev_dct['PVS']['A0'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:A0' % prfx)
    dev_dct['PVS']['A0Max'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:A0Max' % prfx)
    dev_dct['PVS']['A0ForCalc'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:A0:for_calc' % prfx)

    devcfg.msg_splash("connecting to: [%s]" % 'zoneplate definitions')
    dev_dct['PVS']['Zpz_pos'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:zpz_pos' % prfx)
    ...
    dev_dct['PVS']['Zp_select'] = Mbbo('SIM_BL1610-I10:ENERGY:%s:zp' % prfx)
    dev_dct['PVS']['OSA_select'] = Mbbo('SIM_BL1610-I10:ENERGY:%s:osa' % prfx)

    devcfg.msg_splash("connecting to: [%s]" % 'Energy_enable')
    dev_dct['PVS']['Energy_enable'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:enabled' % prfx)
    dev_dct['PVS']['ENERGY_RBV'] = BaseDevice('SIM_BL1610-I10:ENERGY.RBV', egu='um')
    dev_dct['PVS']['ZPZ_RBV'] = BaseDevice('SIM_IOC:m111C.RBV', egu='um')
    dev_dct['PVS']['Zp_def.A'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp:def.A' % prfx)

    devcfg.msg_splash("connecting to: [%s]" % 'Zp_def1 -> 7')
    dev_dct['PVS']['Zp_def1_A'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp1:def.A' % prfx)
    dev_dct['PVS']['Zp_def2_A'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp2:def.A' % prfx)
    dev_dct['PVS']['Zp_def3_A'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp3:def.A' % prfx)
    dev_dct['PVS']['Zp_def4_A'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp4:def.A' % prfx)
    dev_dct['PVS']['Zp_def5_A'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:zp5:def.A' % prfx)
    ...
    dev_dct['PVS_DONT_RECORD']['Set_XY_lockposition'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:set_xy:lockposn' % prfx,
                                                                   units='um')
    dev_dct['PVS_DONT_RECORD']['Set_Z_lockposition'] = BaseDevice('SIM_BL1610-I10:ENERGY:%s:set_z:lock_posn' % prfx,
                                                                  units='um')
    ...
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-01'] = BaseDevice('SIM_TM1610-3-I12-01',
                                                                         desc='Turbo cooling water', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-30]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-30'] = BaseDevice('SIM_TM1610-3-I12-30', desc='Sample Coarse Y',
                                                                         units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-32]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-32'] = BaseDevice('SIM_TM1610-3-I12-32', desc='Detector Y',
                                                                         units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-21]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-21'] = BaseDevice('SIM_TM1610-3-I12-21', desc='Chamber temp #1',
                                                                         units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-22]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-22'] = BaseDevice('SIM_TM1610-3-I12-22', desc='Chamber temp #2',
                                                                         units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-23]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-23'] = BaseDevice('SIM_TM1610-3-I12-23', desc='Chamber temp #3',
                                                                         units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-24]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-24'] = BaseDevice('SIM_TM1610-3-I12-24', desc='Chamber temp #4',
                                                                         units='deg C')

    # pressures
    devcfg.msg_splash("connecting to PRESSURES: [FRG1610-3-I12-01:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['FRG1610-3-I12-01:vac:p'] = BaseDevice('SIM_FRG1610-3-I12-01:vac:p',
                                                                             desc='Chamber pressure', units='torr')
    devcfg.msg_splash("connecting to PRESSURES: [TCG1610-3-I12-03:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['TCG1610-3-I12-03:vac:p'] = BaseDevice('SIM_TCG1610-3-I12-03:vac:p',
                                                                             desc='Turbo backing pressure',
                                                                             units='torr')
    devcfg.msg_splash("connecting to PRESSURES: [TCG1610-3-I12-04:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['TCG1610-3-I12-04:vac:p'] = BaseDevice('SIM_TCG1610-3-I12-04:vac:p',
                                                                             desc='Load lock pressure', units='torr')
    devcfg.msg_splash("connecting to PRESSURES: [TCG1610-3-I12-05:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['TCG1610-3-I12-05:vac:p'] = BaseDevice('SIM_TCG1610-3-I12-05:vac:p',
                                                                             desc='Rough line pressure', units='torr')
...
def connect_heartbeats(dev_dct, prfx='uhv'):
    ...
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['sscan_hrtbt'] = {'dev': BaseDevice('SIM_uhvstxm:hrtbt:alive'),
                                                               'desc': 'SSCAN App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['blApi_hrtbt'] = {'dev': BaseDevice('SIM_uhvBlApi:hrtbt:alive'),
                                                               'desc': 'BlApi App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['ai_hrtbt'] = {'dev': BaseDevice('SIM_uhvAI:hrtbt:alive'),
                                                            'desc': 'AnalogInput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['ci_hrtbt'] = {'dev': BaseDevice('SIM_uhvCI:hrtbt:alive'),
                                                            'desc': 'CounterInput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['co_hrtbt'] = {'dev': BaseDevice('SIM_uhvCO:hrtbt:alive'),
                                                            'desc': 'CounterOutput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['dio_hrtbt'] = {'dev': BaseDevice('SIM_uhvDIO:hrtbt:alive'),
                                                             'desc': 'Digital IO App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_hrtbt'] = {'dev': BaseDevice('SIM_UHVMTRS:hrtbt:alive'),
                                                              'desc': 'Main Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtr_calib_hrtbt'] = {'dev': BaseDevice('SIM_UHVMTR_CALIB:hrtbt:alive'),
                                                                   'desc': 'MotorCalibrations'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_osa_hrtbt'] = {'dev': BaseDevice('SIM_UHVMTR_OSA:hrtbt:alive'),
                                                                  'desc': 'OSA Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_zp_hrtbt'] = {'dev': BaseDevice('SIM_UHVMTR_ZP:hrtbt:alive'),
                                                                 'desc': 'ZPz Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['gate_cntr_scan_cfg'] = {
        'dev': BaseDevice('SIM_gate_cntr_scan_cfg:hrtbt:alive'), 'desc': 'Gate/Counter scan cfg App'}
...
def connect_BL_devices(dev_dct, prfx='uhv'):
    if (prfx.find('uhv') > -1):
        ...
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1410-01:vac:p'] = BaseDevice('SIM_CCG1410-01:vac:p', desc='Sec. 1',
                                                                           units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1410-I00-01:vac:p'] = BaseDevice('SIM_CCG1410-I00-01:vac:p',
                                                                               desc='Sec. 2', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1410-I00-02:vac:p'] = BaseDevice('SIM_CCG1410-I00-02:vac:p',
                                                                               desc='Sec. 4', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-1-I00-02:vac:p'] = BaseDevice('SIM_CCG1610-1-I00-02:vac:p',
                                                                                 desc='Sec. 6', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['HCG1610-1-I00-01:vac:p'] = BaseDevice('SIM_HCG1610-1-I00-01:vac:p',
                                                                                 desc='Sec. 7', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-1-I00-03:vac:p'] = BaseDevice('SIM_CCG1610-1-I00-03:vac:p',
                                                                                 desc='Sec. 8', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-01:vac:p'] = BaseDevice('SIM_CCG1610-I10-01:vac:p',
                                                                               desc='Sec. 10', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-02:vac:p'] = BaseDevice('SIM_CCG1610-I10-02:vac:p',
                                                                               desc='Sec. 11', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-03:vac:p'] = BaseDevice('SIM_CCG1610-I10-03:vac:p',
                                                                               desc='Sec. 12', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I10-04:vac:p'] = BaseDevice('SIM_CCG1610-I10-04:vac:p',
                                                                               desc='Sec. 13', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I12-01:vac:p'] = BaseDevice('SIM_CCG1610-I12-01:vac:p',
                                                                               desc='Sec. 14', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-I12-02:vac:p'] = BaseDevice('SIM_CCG1610-I12-02:vac:p',
                                                                               desc='Sec. 15', units='torr')
        dev_dct['PRESSURES'][POS_TYPE_BL]['CCG1610-3-I12-01:vac:p'] = BaseDevice('SIM_CCG1610-3-I12-01:vac:p',
                                                                                 desc='Sec. 16', units='torr')
...
if (AMBIENT_STXM):
    ...
    DEVICE_CFG = dev_config_sim_ambient(splash=splash, sample_pos_mode=sample_positioning_modes.COARSE,
                                        fine_sample_pos_mode=sample_fine_positioning_modes.SAMPLEFINE)
