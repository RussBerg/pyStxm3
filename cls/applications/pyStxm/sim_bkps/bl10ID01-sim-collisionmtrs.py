...
class dev_config_sim_ambient(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_COARSE_X] = Motor_Qt( 'IOC:m3',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_COARSE_Y] = Motor_Qt( 'IOC:m4',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_OSA_X] = Motor_Qt('IOC:m5',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_OSA_Y] = Motor_Qt('IOC:m6',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_DETECTOR_X] = Motor_Qt( 'IOC:m7',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_DETECTOR_Y] = Motor_Qt( 'IOC:m8',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( 'IOC:m9',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( 'IOC:m90',pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_COARSE_Z] = Motor_Qt('IOC:m93',pos_set=POS_TYPE_ES)
...
class dev_config_amb(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = sample_motor('IOC:m9',pos_set=POS_TYPE_ES)
        ...
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( 'IOC:m9',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( 'IOC:m90',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z_BASE] = Motor_Qt( 'IOC:m90')

        #self.devices['POSITIONERS'][DNM_SAMPLE_X] = Motor_Qt( 'IOC:m91',pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_SAMPLE_Y] = Motor_Qt('IOC:m92',pos_set=POS_TYPE_ES)

        self.devices['POSITIONERS'][DNM_SAMPLE_X] = sample_abstract_motor( 'IOC:m91',pos_set=POS_TYPE_ES)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = sample_abstract_motor('IOC:m92',pos_set=POS_TYPE_ES)
...
class dev_config_uhv(dev_config_base):
    ...
    def init_devices(self):
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_X] = e712_sample_motor('IOC:m900', name='IOC:m900', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_X] = Motor_Qt('IOC:m900', name='IOC:m900')
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_FINE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_FINE_Y] = e712_sample_motor('IOC:m901', name='IOC:m901', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_Y] = Motor_Qt('IOC:m901', name='IOC:m901')
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_X)
        self.devices['POSITIONERS'][DNM_COARSE_X] = Motor_Qt( 'IOC:m912', name='IOC:m912', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_COARSE_Y)
        self.devices['POSITIONERS'][DNM_COARSE_Y] = Motor_Qt( 'IOC:m913', name='IOC:m913', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_X)
        self.devices['POSITIONERS'][DNM_OSA_X] = Motor_Qt('IOC:m904', name='IOC:m904', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Y)
        self.devices['POSITIONERS'][DNM_OSA_Y] = Motor_Qt('IOC:m905', name='IOC:m905', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Z)
        self.devices['POSITIONERS'][DNM_OSA_Z] = Motor_Qt('IOC:m906C', name='IOC:m906C', pos_set=POS_TYPE_ES, collision_support=True)
        self.msg_splash("connecting to: [%s]" % DNM_OSA_Z_BASE)
        self.devices['POSITIONERS'][DNM_OSA_Z_BASE] = Motor_Qt('IOC:m906', name='IOC:m906', )

        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_X)
        self.devices['POSITIONERS'][DNM_DETECTOR_X] = Motor_Qt( 'IOC:m914', name='IOC:m914', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Y)
        self.devices['POSITIONERS'][DNM_DETECTOR_Y] = Motor_Qt( 'IOC:m915', name='IOC:m915', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_DETECTOR_Z)
        self.devices['POSITIONERS'][DNM_DETECTOR_Z] = Motor_Qt( 'IOC:m916', name='IOC:m916', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_X)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_X] = e712_sample_motor( 'IOC:m902', name='IOC:m902', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_ZX] = Motor_Qt( 'IOC:m902', name='IOC:m902')
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Y)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Y] = e712_sample_motor( 'IOC:m903', name='IOC:m903', pos_set=POS_TYPE_ES)
        #self.devices['POSITIONERS'][DNM_FINE_ZY] = Motor_Qt('IOC:m902', name='IOC:m902')
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Z)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z] = Motor_Qt( 'IOC:m911C', name='IOC:m911C', pos_set=POS_TYPE_ES, collision_support=True)
        self.msg_splash("connecting to: [%s]" % DNM_ZONEPLATE_Z_BASE)
        self.devices['POSITIONERS'][DNM_ZONEPLATE_Z_BASE] = Motor_Qt( 'IOC:m911', name='IOC:m911' )
        ...
        self.devices['POSITIONERS'][DNM_SAMPLE_X] = sample_abstract_motor( 'IOC:m917', name='IOC:m917', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_SAMPLE_Y)
        self.devices['POSITIONERS'][DNM_SAMPLE_Y] = sample_abstract_motor('IOC:m918', name='IOC:m918', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_X)
        self.devices['POSITIONERS'][DNM_GONI_X] = Motor_Qt('IOC:m907', name='IOC:m907', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_Y)
        self.devices['POSITIONERS'][DNM_GONI_Y] = Motor_Qt('IOC:m908', name='IOC:m908', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_Z)
        self.devices['POSITIONERS'][DNM_GONI_Z] = Motor_Qt('IOC:m909', name='IOC:m909', pos_set=POS_TYPE_ES)
        self.msg_splash("connecting to: [%s]" % DNM_GONI_THETA)
        self.devices['POSITIONERS'][DNM_GONI_THETA] = Motor_Qt('IOC:m910', name='IOC:m910', pos_set=POS_TYPE_ES)
...
def connect_standard_beamline_positioners(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['POSITIONERS'][DNM_ENERGY] = Motor_Qt('BL1610-I10:ENERGY', name='BL1610-I10:ENERGY', abstract_mtr=True, pos_set=POS_TYPE_ES)
    devcfg.msg_splash("connecting to: [%s]" % DNM_SLIT_X)
    dev_dct['POSITIONERS'][DNM_SLIT_X] = Motor_Qt('BL1610-I10:slitX', name='BL1610-I10:slitX', abstract_mtr=True, pos_set=POS_TYPE_BL)
...
#    dev_dct['DETECTORS_NO_RECORD']['OsaCntr_Snapshot'] = BaseDevice('%sPMT:osa_snapshot_RBV' % prfx)
    ...
    dev_dct['PVS'][DNM_ENERGY_ENABLE] = BaseDevice('BL1610-I10:ENERGY:%s:enabled' % prfx)
    ...
    dev_dct['PVS'][DNM_MONO_EV_FBK] = BaseDevice('MONO1610-I10-01:energy:fbk', units='eV')
    ...
    dev_dct['PVS'][DNM_BEAM_DEFOCUS] = BaseDevice('BL1610-I10:ENERGY:%s:zp:defocus' % prfx, units='um')


    dev_dct['PVS_DONT_RECORD']['ticker'] = BaseDevice('TRG2400:cycles', egu='counts')

    dev_dct['PVS_DONT_RECORD']['CX_auto_disable_power'] = BaseDevice('IOC:m912:XPS_AUTO_DISABLE_MODE')
    dev_dct['PVS_DONT_RECORD']['CY_auto_disable_power'] = BaseDevice('IOC:m913:XPS_AUTO_DISABLE_MODE')
    dev_dct['PVS_DONT_RECORD']['DX_auto_disable_power'] = BaseDevice('IOC:m914:XPS_AUTO_DISABLE_MODE')
    dev_dct['PVS_DONT_RECORD']['DY_auto_disable_power'] = BaseDevice('IOC:m915:XPS_AUTO_DISABLE_MODE')
...
#    dev_dct['PVS_DONT_RECORD']['OSAZ_goto_lockposition'] = BaseDevice('BL1610-I10:ENERGY:%s:osaz_goto_lockpos' % prfx)
    ...
    dev_dct['PVS_DONT_RECORD']['Set_XY_lockposition'] = BaseDevice('BL1610-I10:ENERGY:%s:set_xy:lockposn' % prfx, units='um')
    dev_dct['PVS_DONT_RECORD']['Set_Z_lockposition'] = BaseDevice('BL1610-I10:ENERGY:%s:set_z:lock_posn' % prfx, units='um')

    dev_dct['PVS'][DNM_AX1_INTERFER_VOLTS] = BaseDevice('%sAi:ai:ai0_RBV' % prfx, rd_only=True)
    dev_dct['PVS'][DNM_AX2_INTERFER_VOLTS] = BaseDevice('%sAi:ai:ai1_RBV' % prfx, rd_only=True)
    ...
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-01'] = BaseDevice('TM1610-3-I12-01', desc='Turbo cooling water', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-30]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-30'] = BaseDevice('TM1610-3-I12-30', desc='Sample Coarse Y', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-32]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-32'] = BaseDevice('TM1610-3-I12-32', desc='Detector Y', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-21]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-21'] = BaseDevice('TM1610-3-I12-21', desc='Chamber temp #1', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-22]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-22'] = BaseDevice('TM1610-3-I12-22', desc='Chamber temp #2', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-23]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-23'] = BaseDevice('TM1610-3-I12-23', desc='Chamber temp #3', units='deg C')
    devcfg.msg_splash("connecting to TEMPERATURES: [TM1610-3-I12-24]")
    dev_dct['TEMPERATURES'][POS_TYPE_ES]['TM1610-3-I12-24'] = BaseDevice('TM1610-3-I12-24', desc='Chamber temp #4', units='deg C')


    #pressures
    devcfg.msg_splash("connecting to PRESSURES: [FRG1610-3-I12-01:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['FRG1610-3-I12-01:vac:p'] = BaseDevice('FRG1610-3-I12-01:vac:p', desc='Chamber pressure', units='torr')
    devcfg.msg_splash("connecting to PRESSURES: [TCG1610-3-I12-03:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['TCG1610-3-I12-03:vac:p'] = BaseDevice('TCG1610-3-I12-03:vac:p', desc='Turbo backing pressure', units='torr')
    devcfg.msg_splash("connecting to PRESSURES: [TCG1610-3-I12-04:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['TCG1610-3-I12-04:vac:p'] = BaseDevice('TCG1610-3-I12-04:vac:p', desc='Load lock pressure', units='torr')
    devcfg.msg_splash("connecting to PRESSURES: [TCG1610-3-I12-05:vac:p]")
    dev_dct['PRESSURES'][POS_TYPE_ES]['TCG1610-3-I12-05:vac:p'] = BaseDevice('TCG1610-3-I12-05:vac:p', desc='Rough line pressure', units='torr')
...
def connect_heartbeats(dev_dct, prfx='uhv'):
    ...
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['sscan_hrtbt'] = {'dev':BaseDevice('uhvstxm:hrtbt:alive'), 'desc':'SSCAN App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['blApi_hrtbt'] = {'dev':BaseDevice('uhvBlApi:hrtbt:alive'), 'desc':'BlApi App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['ai_hrtbt'] = {'dev': BaseDevice('uhvAI:hrtbt:alive'),
                                                            'desc': 'AnalogInput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['ci_hrtbt'] = {'dev':BaseDevice('uhvCI:hrtbt:alive'), 'desc':'CounterInput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['co_hrtbt'] = {'dev':BaseDevice('uhvCO:hrtbt:alive'), 'desc':'CounterOutput App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['dio_hrtbt'] = {'dev':BaseDevice('uhvDIO:hrtbt:alive'), 'desc':'Digital IO App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_hrtbt'] = {'dev':BaseDevice('UHVMTRS:hrtbt:alive'), 'desc':'Main Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtr_calib_hrtbt'] = {'dev':BaseDevice('UHVMTR_CALIB:hrtbt:alive'), 'desc':'MotorCalibrations'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_osa_hrtbt'] = {'dev':BaseDevice('UHVMTR_OSA:hrtbt:alive'), 'desc':'OSA Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['mtrs_zp_hrtbt'] = {'dev':BaseDevice('UHVMTR_ZP:hrtbt:alive'), 'desc':'ZPz Motors App'}
    dev_dct['PVS_DONT_RECORD']['HEARTBEATS']['gate_cntr_scan_cfg'] = {'dev':BaseDevice('gate_cntr_scan_cfg:hrtbt:alive'), 'desc':'Gate/Counter scan cfg App'}
...
def connect_e712(dev_dct, prfx='uhv', e712_prfx='IOCE712'):
    ...
    dev_dct['WIDGETS'][DNM_E712_OPHYD_DEV] = E712WGDevice('IOCE712:', name='e712_wgenerator_flyerdev')
    # waveform PV
    dev_dct['PVS_DONT_RECORD']['e712_dwells'] = BaseDevice('%s:dwells' % e712_prfx, units='mA')
    dev_dct['PVS_DONT_RECORD']['e712_xresetposns'] = BaseDevice('%s:xreset:posns' % e712_prfx, units='um')
    dev_dct['PVS_DONT_RECORD']['e712_yresetposns'] = BaseDevice('%s:yreset:posns' % e712_prfx, units='um')
    dev_dct['PVS_DONT_RECORD']['e712_sp_ids'] = BaseDevice('%s:sp_roi:ids' % e712_prfx)
    dev_dct['PVS_DONT_RECORD']['e712_current_sp_id'] = BaseDevice('%s:sp_roi:current' % e712_prfx)
    dev_dct['PVS_DONT_RECORD']['e712_x_start_pos'] = BaseDevice('%s:XStartPos' % e712_prfx)
    dev_dct['PVS_DONT_RECORD']['e712_y_start_pos'] = BaseDevice('%s:YStartPos' % e712_prfx)

    # pvs that will hold up to 10 DDL tables for a multi spatial scan
    dev_dct['PVS_DONT_RECORD']['e712_ddl_tbls'] = [ BaseDevice('%s:ddl:0' % e712_prfx),
    ...
    dev_dct['PVS_DONT_RECORD']['e712_image_idx'] = BaseDevice('%s:image_idx' % e712_prfx)
    dev_dct['PVS_DONT_RECORD']['e712_scan_mode'] = BaseDevice('%s:ScanMode' % e712_prfx)
    ...
    if (MAIN_OBJ.get_fine_sample_positioning_mode() is sample_fine_positioning_modes.ZONEPLATE):
        ...
        dev_dct['PVS_DONT_RECORD']['e712_x_start_mode'] = BaseDevice('%s:wg3:startmode' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_start_mode'] = BaseDevice('%s:wg4:startmode' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_wavtbl_ids'] = BaseDevice('%s:wg3_tbl:ids' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_wavtbl_ids'] = BaseDevice('%s:wg4_tbl:ids' % e712_prfx)

        # short PV's
        dev_dct['PVS_DONT_RECORD']['e712_x_npts'] = BaseDevice('%s:wg3:npts' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_npts'] = BaseDevice('%s:wg4:npts' % e712_prfx)

        # pvs that hold the flags for each waveformgenerator (4) for each supported sp_roi (max of 10)
        dev_dct['PVS_DONT_RECORD']['e712_x_useddl'] = BaseDevice('%s:wg3:useddl' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_useddl'] = BaseDevice('%s:wg4:useddl' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_usereinit'] = BaseDevice('%s:wg3:usereinit' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_usereinit'] = BaseDevice('%s:wg4:usereinit' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_strtatend'] = BaseDevice('%s:wg3:strtatend' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_strtatend'] = BaseDevice('%s:wg4:strtatend' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_usetablenum'] = BaseDevice('%s:WavGen3UseTblNum' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_usetablenum'] = BaseDevice('%s:WavGen4UseTblNum' % e712_prfx)

    else:
        # here using x1 and y1 because we are sample scanning and they are channels 1 and 2 respectively
        # waveform PV's
        dev_dct['PVS_DONT_RECORD']['e712_x_start_mode'] = BaseDevice('%s:wg1:startmode' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_start_mode'] = BaseDevice('%s:wg2:startmode' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_wavtbl_ids'] = BaseDevice('%s:wg1_tbl:ids' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_wavtbl_ids'] = BaseDevice('%s:wg2_tbl:ids' % e712_prfx)

        # short PV's
        dev_dct['PVS_DONT_RECORD']['e712_x_npts'] = BaseDevice('%s:wg1:npts' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_npts'] = BaseDevice('%s:wg2:npts' % e712_prfx)

        # pvs that hold the flags for each waveformgenerator (4) for each supported sp_roi (max of 10)
        dev_dct['PVS_DONT_RECORD']['e712_x_useddl'] = BaseDevice('%s:wg1:useddl' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_useddl'] = BaseDevice('%s:wg2:useddl' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_usereinit'] = BaseDevice('%s:wg1:usereinit' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_usereinit'] = BaseDevice('%s:wg2:usereinit' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_strtatend'] = BaseDevice('%s:wg1:strtatend' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_strtatend'] = BaseDevice('%s:wg2:strtatend' % e712_prfx)

        dev_dct['PVS_DONT_RECORD']['e712_x_usetablenum'] = BaseDevice('%s:WavGen1UseTblNum' % e712_prfx)
        dev_dct['PVS_DONT_RECORD']['e712_y_usetablenum'] = BaseDevice('%s:WavGen2UseTblNum' % e712_prfx)
