...
def connect_devices(dev_dct, prfx='uhv', devcfg=None):
    ...
    dev_dct['DIO']['POINT_GATE'] = GateDevice('SIM_uhvCO:gate:', name='gate_control')

    dev_dct['DETECTORS']['LINE_DET'] = LineDetectorDevice('SIM_uhvCI:counter:', name=DNM_DEFAULT_COUNTER)
    dev_dct['DETECTORS']['LINE_DET_FLYER'] = LineDetectorFlyerDevice('SIM_uhvCI:counter:', name=DNM_DEFAULT_COUNTER,
