...
class Motor(device.Device):
    """Epics Motor Class, with automatic callbacks
   ...
   Example use:
    ...
    __motor_params = {
        ...
        'done_moving':     ('done_moving', 'Done moving to value'),
        ...
        'drive':           ('setpoint',  'User Desired Value'),
        'base_speed':      ('VBAS', 'Base Velocity (EGU/s)'),
        'slew_speed':      ('velocity', 'Velocity (EGU/s) '),
