...
from my_callback import MyCollectThenCompute
...
if __name__ == '__main__':
    ...
    # # installs print as the callback to exeute
    #
    # # d.subscribe(print)
    # d.subscribe(mycallback)
    #
