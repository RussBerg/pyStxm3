...
class ImageWidgetPlot(ImageDialog):
    ...
    def __init__(
        ...
        super(ImageWidgetPlot, self).__init__(wintitle="",
...
#             y2 = y1 + item.max_range[1]
    ...
    def add_image_from_file(self, fname, alpha=0.4):
        ...
        #     item.boundingRect().moveCenter(self.item[-1].boundingRect().center())
        #     item.update_bounds()
        # else:
        #     item.boundingRect().moveCenter(self.item[0].boundingRect().center())
        #     item.update_bounds()
...
def make_pystxm_window():
    ...
    win = ImageWidgetPlot(parent=None, filtStr=FILTER_STRING, type=None,
