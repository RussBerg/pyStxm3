...
class Dialog(QtWidgets.QDialog):
    ...
    def loadFromFile(self):
        ...
        fileName = QtWidgets.QFileDialog.getOpenFileName(self, None, None,"Images (*.png *.xpm *.jpg)")
        image = QtGui.QImage()
        if not image.load(fileName[0]):
        ...
        try:
            ...
            print('loadFromFile: Exception:' ,e)
            self.sharedMemory.unlock()
    ...
    def loadFromMemory(self):
        ...
        try:
            ...
            print('loadFromMemory: Exception:', e)
