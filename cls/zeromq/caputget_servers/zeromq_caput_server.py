...
#################################################
def start_caput_server(host, port, base_dir, compression_type=compression_types.PICKLE):
...
if __name__ == '__main__':
    ...
    #start_caput_server(_host, _port, _save_dir, compression_type=compression_types.MSGPACK)
    #start_caput_server(_host, _port, _save_dir, compression_type=compression_types.PICKLE)
    Process(target=start_caput_server, args=(_host, put_port, _save_dir, compression_types.PICKLE,)).start()
